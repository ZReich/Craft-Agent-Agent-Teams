...
const COMPAT_ANTHROPIC_DEFAULTS = 'anthropic/claude-opus-4.6, anthropic/claude-sonnet-4.6, anthropic/claude-sonnet-4.5, anthropic/claude-haiku-4.5'
        ...
        <div className="space-y-2">
          ...
          <div className={cn(
            ...
            <Input
              ...
              placeholder={providerType === 'openai' ? "e.g. openai/gpt-5.2-codex, openai/gpt-5.1-codex-mini" : "e.g. anthropic/claude-opus-4.6, anthropic/claude-sonnet-4.6, anthropic/claude-haiku-4.5"}
              className="border-0 bg-transparent shadow-none"
              disabled={isDisabled}
            />
          </div>
